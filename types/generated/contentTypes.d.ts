...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blogtexteditor: Schema.Attribute.RichText &
      Schema.Attribute.Required &
    ...
    FeaturedImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    hasSponsor: Schema.Attribute.Boolean;
    ...
    sponsor_tagline: Schema.Attribute.Text;
    sponsor_url: Schema.Attribute.String;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authorId: Schema.Attribute.Text;
    ...
    commentAuthorEmail: Schema.Attribute.String;
    comments: Schema.Attribute.Relation<'manyToOne', 'api::comment.comment'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDigestDigest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actorImage: Schema.Attribute.String;
...
export interface ApiPopularPostPopularPost extends Struct.SingleTypeSchema {
  collectionName: 'popular_posts';
  info: {
    displayName: 'Popular Posts';
    pluralName: 'popular-posts';
    singularName: 'popular-post';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::popular-post.popular-post'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Component<'posts.popular-post', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    inlinelogo: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    projecttexteditor: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiReplyReply extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authorEmail: Schema.Attribute.Text;
    ...
    parentAuthorName: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSavedPostsCollectionSavedPostsCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'saved_posts_collections';
  info: {
    description: '';
    displayName: 'SavedPostsCollection';
    pluralName: 'saved-posts-collections';
    singularName: 'saved-posts-collection';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isSaved: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-posts-collection.saved-posts-collection'
    > &
      Schema.Attribute.Private;
    postId: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::popular-post.popular-post': ApiPopularPostPopularPost;
      'api::project.project': ApiProjectProject;
      'api::reply.reply': ApiReplyReply;
      'api::saved-post.saved-post': ApiSavedPostSavedPost;
      'api::saved-posts-collection.saved-posts-collection': ApiSavedPostsCollectionSavedPostsCollection;
